...
class ProductAPITest(TestCase):
    ...
    def test_create_product_authenticated(self):
        ...
        resp = self.client.post(reverse('product-list-create'), data, format='json')
    ...
    def test_search_and_filter(self):
        ...
        Product.objects.create(name='Phone Case', price=9.99, category=self.cat, stock_quantity=50)
        Product.objects.create(name='Laptop', price=999.99, category=self.cat, stock_quantity=5)
